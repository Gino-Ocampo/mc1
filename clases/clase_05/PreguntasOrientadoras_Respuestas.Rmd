...
- Estratégica: propiedades de sus sujetos de estudio con el fin de asignarles números a las magnitudes, grados o tipos en que estos las poseen y que utiliza procedimientos estadísticos para resumir, manipular y asociar dichos números. 
...
- se suelen usar constructos latentes que vienen de teorías e investigaciones: de lo abstracto a lo concreto
- operacionalización: cómo se realizaría
...
- (): argumentos: qué son y qué va entre los argumentos. 
